...
import { posts, UserActive } from "./dummyData";
import { AspectRatio } from "@radix-ui/react-aspect-ratio";
import { Image } from "@radix-ui/react-avatar";
import { MessageSquareText } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { useNavigate } from "react-router-dom";
import { AvatarModal } from "@/components/hooks/avatarModal";
      ...
      <div className="m-6 mt-4">
        ...
        <div className="relative p-2 pb-0">
          ...
          <div className="grid gap-1">
            <h1 className="text-xl font-semibold">{UserActive.name}</h1>
            <p className="text-gray-400 font-sm">@{UserActive.username}</p>
      ...
      <div className="flex mt-4 border-b border-gray-700 text-sm font-semibold">
        <button
          className={`flex-1 py-3 text-center ${
            activeTab === "all" ? "border-b-2 border-green-400" : ""
          }`}
        ...
        <button
          className={`flex-1 py-3 text-center ${
            activeTab === "media" ? "border-b-2 border-green-400" : ""
          }`}
